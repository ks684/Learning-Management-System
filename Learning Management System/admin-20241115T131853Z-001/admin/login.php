...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($errors)) {
        ...
        $query = "SELECT * FROM admin WHERE Username = :username"; // Use the correct column name
        ...
        if ($admin && isset($admin['Password']) && password_verify($password, $admin['Password'])) {
            $_SESSION['admin'] = $username; // Store user session
    ...
    <div class="container">
        <section class="login-form">
            <div class="text-center">
                ...
                <h2 class="mb-3">Teacher's Login</h2>
            </div>
            <?php if (!empty($errors)) : ?>
            ...
            <?php endif; ?>
            <form action="" method="POST"> <!-- Form action is empty to submit to the same page -->
                <div class="mb-3">
